module march_c(
    ...
    // Logic điều hướng (11N)
    wire expected_data_is_1 = (march_step == 3'd2) || (march_step == 3'd4);
    wire has_write_action   = (march_step == 3'd1) || (march_step == 3'd2) || 
                              (march_step == 3'd4) || (march_step == 3'd5);
    wire write_data_is_1    = (march_step == 3'd1) || (march_step == 3'd3);
        ...
        if (!nRESET) begin
            ...
            case (state)
                ...
                COMPARE: begin
                    ...
                    compSel_reg     <= 4'b1111; // Mở khóa toàn bộ bank
                    state           <= RST_COMP;
                end
                ...
                RST_COMP: begin
                    ...
                    if (has_write_action) begin
                        gen_Turn_reg <= turn_write; state <= WRITE_ACTION;
                    end else state <= NEXT_ADDR;
                end
